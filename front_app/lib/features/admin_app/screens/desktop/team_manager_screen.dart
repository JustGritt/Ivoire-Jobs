...
class _TeamManagerScreenScreenState extends State<TeamManagerScreen> {
        ...
        return StatefulBuilder(
          builder: (context, setState) {
            return AlertDialog(
              ...
              content: Container(
                width: MediaQuery.of(context).size.width * 0.6, // Set the width here
                child: Form(
                  key: _formKey,
                  child: Column(
  ...
  void _createAdminUser(
    ...
    AdminUser newUser = AdminUser(
      ...
      lastName: lastName,
      email: email,
      profilePicture: '', // You can update this based on your needs
      bio: '',
      id: '', // The id should be generated by the backend
      role: 'admin',
      password: password,
    );
    ...
    try {
      ...
      getUsers(); // Refresh the user list after creating a new admin
    } catch (e) {
